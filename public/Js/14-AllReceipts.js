...
function ShowAllReceipts(MainData, Decode) {
    ...
    MainData.GeneralData.forEach(Receipt => {
        ...
        if (!Receipt.DocType.includes("سند")) {
            ...
            if (Receipt.DocType.includes("تأجير")) { SumSales += Receipt.Total }
            if (Receipt.DocType.includes("استئجأر")) { NameReceipt = "Purchases"; SumPurchases += Receipt.Total }
            ...
            <tr id="${Receipt._id}">
                ...
                <td>
                    <div class="FlexTD">
                        <div class="btn-box">
                            <div class="tooltip">عرض الفاتورة</div>
...
function CreateArray() {
    ...
    AllRows.forEach((Row) => {
        TableObj = {
            ...
            btnFile: Row.querySelectorAll("td")[8].querySelector(".btn-File").getAttribute("href"),
            btnEdit: Row.querySelectorAll("td")[8].querySelector(".btn-Edit").getAttribute("href"),
        }
