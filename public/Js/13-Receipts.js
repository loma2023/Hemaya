...
function NewReceipt(event) {
  ...
  // في حالة التأجير النقدية
  if (DocType === "تأجير" && TypeAmount === "نقدي") {
    Statment = "تأجير نقدية", Debit = "الصندوق", Credit = "التأجير", SubDebit = "مقبوضات", SubCredit = "تأجير نقدية";
  }
  ...
  // في حالة الاستئجأر النقدية
  if (DocType === "استئجأر" && TypeAmount === "نقدي") {
    Statment = "استئجأر نقدية", Debit = "الاستئجأر", Credit = "الصندوق", SubDebit = "استئجأر نقدية", SubCredit = "مدفوعات";
  }
  ...
  // في حالة مرتجع الاستئجأر النقدية
