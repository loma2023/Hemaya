...
router.put("/CustomersData:id", RequireAuth, async (req, res) => {
  ...
  await HemayaUser.updateOne({ "CustomersData._id": req.params.id },
    {
...
router.put("/NewTimeCustomer:id", RequireAuth, async (req, res) => {
  ...
  await HemayaUser.updateOne({ "TimeCustomersData._id": req.params.id },
    {
      "TimeCustomersData.$.Name": req.body.Name,
      "TimeCustomersData.$.DocType": req.body.DocType,
